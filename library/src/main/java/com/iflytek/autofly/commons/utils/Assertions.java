...
/**
 * Provides methods for asserting the truth of expression and properties
 */
public class Assertions {

    /**
     * Whether the assertions checks enabled. If your application release, should be disabled.
     */
     ...
     */
    public static void checkIndex(int index, int start, int limit) {
        if (ASSERTIONS_ENABLED && (index < start || index >= limit)) {
